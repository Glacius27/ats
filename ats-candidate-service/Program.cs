...
var postgresDb = config["POSTGRES_DB"] ?? "ats_candidates";
...
{
    var minioEndpoint = config["MinioSettings__Endpoint"] ?? config["MinioSettings:Endpoint"] ?? "localhost:9000";
    var minioAccessKey = config["MinioSettings__AccessKey"] ?? config["MinioSettings:AccessKey"] ?? "minioadmin";
    var minioSecretKey = config["MinioSettings__SecretKey"] ?? config["MinioSettings:SecretKey"] ?? "minioadmin";
